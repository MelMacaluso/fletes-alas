    ...
    <div class="container mx-auto relative">
      <div class="max-w-sm mx-auto">
        <transition name="fade">
            <form v-show="!submitted" @submit.prevent="findBookingInPipedrive">
        ...
        <transition name="fade">
            <div v-if="dealDetails" class="relative mt-8 bg-white p-5 rounded shadow-md flex flex-col justify-center text-left">
